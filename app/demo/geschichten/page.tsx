  ...
  return (
    <div style={{ background: '#000', color: '#fff', padding: '12px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
      <p className="font-sans" style={{ fontSize: 13 }}>
        ...
        <strong>Demo-Ansicht</strong> — Das ist ein Beispiel-Erinnerungsbuch.
      </p>
...
export default function DemoGeschichtenPage() {
  return (
    <div>
      <DemoBanner />
      <GeschichtenScreen bookId={DEMO_BOOK_ID} basePath="/demo" />
    </div>
  )
}
